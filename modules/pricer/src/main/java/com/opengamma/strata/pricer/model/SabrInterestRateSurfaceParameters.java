...
public final class SabrInterestRateSurfaceParameters
   ...
   * @return {@code SabrInterestRateSurfaceParameters}
   */
  @SuppressWarnings("javadoc")
  public static SabrInterestRateSurfaceParameters of(
    ...
    return new SabrInterestRateSurfaceParameters(
  ...
  private SabrInterestRateSurfaceParameters(
      Surface alphaSurface,
      Surface betaSurface,
      Surface rhoSurface,
      Surface nuSurface,
  ...
  @Override
  public SabrInterestRateSurfaceParameters withParameter(int parameterIndex, double newValue) {
    return new SabrInterestRateSurfaceParameters(
  ...
  @Override
  public SabrInterestRateSurfaceParameters withPerturbation(ParameterPerturbation perturbation) {
    return new SabrInterestRateSurfaceParameters(
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code SabrInterestRateSurfaceParameters}.
   */
  private static MetaBean META_BEAN = LightMetaBean.of(SabrInterestRateSurfaceParameters.class);
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      SabrInterestRateSurfaceParameters other = (SabrInterestRateSurfaceParameters) obj;
  ...
  public String toString() {
    ...
    buf.append("SabrInterestRateSurfaceParameters{");

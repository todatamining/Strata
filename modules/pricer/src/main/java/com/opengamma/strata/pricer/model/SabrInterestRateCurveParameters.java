...
public final class SabrInterestRateCurveParameters
...
//-------------------------------------------------------------------------
  ...
  * @return {@code SabrInterestRateCurveParameters}
  */
  public static SabrInterestRateCurveParameters of(
      Curve alphaCurve,
      Curve betaCurve,
      Curve rhoCurve,
      Curve nuCurve,
    ...
    return new SabrInterestRateCurveParameters(
  ...
  */
  ...
  private SabrInterestRateCurveParameters(
      Curve alphaCurve,
      Curve betaCurve,
      Curve rhoCurve,
      Curve nuCurve,
...
//-------------------------------------------------------------------------
  ...
  @Override
  public SabrInterestRateCurveParameters withParameter(int parameterIndex, double newValue) {
    return new SabrInterestRateCurveParameters(
  ...
  @Override
  public SabrInterestRateCurveParameters withPerturbation(ParameterPerturbation perturbation) {
    return new SabrInterestRateCurveParameters(
...
//-------------------------------------------------------------------------
  ...
  */
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code SabrInterestRateCurveParameters}.
   */
  private static MetaBean META_BEAN = LightMetaBean.of(SabrInterestRateCurveParameters.class);
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      SabrInterestRateCurveParameters other = (SabrInterestRateCurveParameters) obj;
  ...
  public String toString() {
    ...
    buf.append("SabrInterestRateCurveParameters{");

...
public class IsdaHomogenousCdsIndexTradePricerTest {
  ...
  private static final CreditRatesProvider RATES_PROVIDER = CreditRatesProvider.builder()
      ...
      .recoveryRateCurves(ImmutableMap.of(INDEX_ID, RECOVERY_RATES))
      .build();
  ...
  private static final ResolvedCdsIndexTrade TRADE = ResolvedCdsIndexTrade.builder()
      .product(PRODUCT)
      .info(TRADE_INFO)
      .upfrontFee(UPFRONT)
      .build();
  private static final ResolvedCdsIndexTrade TRADE_NO_SETTLE_DATE = ResolvedCdsIndexTrade.builder()
      .product(PRODUCT)
      .info(TradeInfo.of(VALUATION_DATE))
      .build();

  private static final IsdaHomogenousCdsIndexTradePricer PRICER = IsdaHomogenousCdsIndexTradePricer.DEFAULT;
  private static final IsdaHomogenousCdsIndexTradePricer PRICER_MF =
      new IsdaHomogenousCdsIndexTradePricer(AccrualOnDefaultFormula.MARKIT_FIX);
  private static final IsdaHomogenousCdsIndexProductPricer PRICER_PRODUCT = IsdaHomogenousCdsIndexProductPricer.DEFAULT;
